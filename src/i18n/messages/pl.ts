...
export const pl = {
  ...
  'customers.actions.refresh': 'Odśwież dane',
  ...
  'customers.table.column.group': 'Grupa kapitałowa',
  'customers.table.column.sector': 'Typ klienta',
  'customers.table.column.reviewDate': 'Data przeglądu',

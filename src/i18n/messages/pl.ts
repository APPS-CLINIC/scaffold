...
export const pl = {
  ...
  'customers.table.column.type': 'Typ klienta',
  'customers.table.column.reviewDate': 'Data przeglądu ratingu',
  'customers.table.column.lendingReviewDate': 'Data przeglądu kredytowego',
  'customers.table.column.priceConditionStatus': 'Status warunków cenowych TS',
  'customers.table.column.priceConditionEndDate': 'Data końcowa warunków TS',
  ...
  'customers.table.detail.lendingAdvisor': 'Doradca kredytowy',
  'customers.table.detail.sfAdvisor': 'Doradca SF',
  'customers.table.detail.pcmAdvisor': 'Doradca PCM',
  'customers.table.detail.fmAdvisor': 'Doradca FM',
  'customers.table.detail.tsAdvisor': 'Doradca TS',
  'customers.table.detail.ebdAdvisor': 'Doradca EBD',
  'customers.table.detail.implementationAdvisor': 'Doradca wdrożeniowy',
  'customers.table.detail.customerServiceAdvisor': 'Obsługa klienta',
